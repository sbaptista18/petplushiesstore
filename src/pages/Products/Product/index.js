...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const options = {
        method: "GET",
        url: `https://develop.petplushies.pt:8000/product/product_slug?product_slug=${productUrl}`,
      };
      ...
      axios
        ...
        .then((response) => {
          ...
          const options_reviews = {
            method: "GET",
            url: `https://develop.petplushies.pt:8000/get_reviews?prodId=${productMainDetails[0].ID}`,
          };
  ...
  const addToCart = async (product) => {
    ...
    if (cartId !== null || cartId === 0) {
      ...
      const options1 = {
        method: "POST",
        url: `https://develop.petplushies.pt:8000/temp_cart_products`,
      ...
      const options1 = {
        method: "POST",
        url: `https://develop.petplushies.pt:8000/temp_carts`,
    ...
    if (rating == 0) setErrorRating("Tem de fornecer uma pontuação.");
      ...
      form
        ...
        .then(() => {
          ...
          const options = {
            method: "POST",
            url: `https://develop.petplushies.pt:8000/reviews`,
